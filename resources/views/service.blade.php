...
<body>
	<div class="container mb-md-2">
		...
		<!-- Navbar -->
			<nav class="navbar navbar-light">
			  ...
			  <form class="form-inline"><b>
		        ...
		        <a href="#" style="color: black;"><u>SERVICE</u></a>&nbsp;&nbsp;&nbsp;
		...
		<div style="background-color: black; padding:15px 15px 15px 15px;" style="width: 100%; height: 530px;">
			<div class="card-group">
			  <div class="card" style="background-color: black; padding:15px 15px 15px 15px;">
			    <img src="/carousel/img01.png" class="card-img-top" alt="...">
			  </div>
			  <div class="card" style="background-color: black; padding:15px 15px 15px 15px;">
			    <img src="/carousel/img01.png" class="card-img-top" alt="...">
			  </div>
